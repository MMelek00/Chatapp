...
import { FormLabel, FormInput, Button, Text, CheckBox } from "react-native-elements";
        ...
        return (
            <KeyboardAvoidingView behavior="position" keyboardVerticalOffset={-64}>
                ...
                <View style={styles.inputCard}>
                    ...
                    <FormInput value={firstName} onChangeText={v => this.handleChange("firstName", v)} />
                </View>
                <View style={styles.inputCard}>
                    <CheckBox
                        checked={changeEmail}
                ...
                <Button onPress={this.handleSubmit} buttonStyle={styles.button} title="Update" />
