...
export function signUp(formData) {
    ...
    }).catch(async (err) => { await status(dispatch, "signup", "error", err.message); throw err.message; });
}
...
export function login(formData) {
    ...
    }).catch(async (err) => { await status(dispatch, "login", "error", err.message); throw err.message; });
}
...
export function resetPassword(formData) {
    ...
    return dispatch => new Promise(async (resolve, reject) => {
        ...
        return Firebase.auth()
            ...
            .then(() => status(dispatch, "resetpassword", "loading", false).then(resolve(dispatch({ type: "USER_RESET" }))))
            .catch(reject);
    }).catch(async (err) => { await status(dispatch, "resetpassword", "error", err.message); throw err.message; });
}
...
export function updateProfile(formData) {
    ...
    }).catch(async (err) => { await status(dispatch, "updateprofile", "error", err.message); throw err.message; });
}
...
export function logout() {
    ...
    }).catch(async (err) => { await status(dispatch, "logout", "error", err.message); throw err.message; });
}
